...
def initialize(consoleLogging=True):
    ...
    with INIT_LOCK:
        ...
        global LOG_DIR, WEB_PORT, WEB_LOG, WEB_ROOT, WEB_USERNAME, WEB_PASSWORD, WEB_HOST, WEB_IPV6, USE_API, API_KEY, ENABLE_HTTPS, HTTPS_CERT, HTTPS_KEY, \
                ...
                NAMING_EP_NAME, NAMING_SEP_TYPE, EPISODE_TITLE_SEP_TYPE, NAMING_USE_PERIODS, WOMBLE, \
                ...
                COMING_EPS_LAYOUT, COMING_EPS_SORT, COMING_EPS_DISPLAY_PAUSED, METADATA_WDTV, METADATA_TIVO, IGNORE_WORDS, TRY_HARD_LINK
        ...
        EPISODE_TITLE_SEP_TYPE = check_setting_int(CFG, 'General', 'episode_title_sep_type', 0)
        ...
        TRY_HARD_LINK = check_setting_int(CFG, 'General', 'try_hard_link', 0)
...
def save_config():
    ...
    new_config['General']['episode_title_sep_type'] = int(EPISODE_TITLE_SEP_TYPE)
    ...
    new_config['General']['try_hard_link'] = int(TRY_HARD_LINK)
